...
pub enum ControlId {
    ...
    LensShadingCorrectionEnable = LENS_SHADING_CORRECTION_ENABLE,
    ...
    /// frames earlier.
    #[cfg(feature = "vendor_rpi")]
    ControlListSequence = CONTROL_LIST_SEQUENCE,
}
impl ControlId {
    pub fn id(&self) -> u32 {
        u32::from(*self)
...
"
            ...
            ControlId::LensDewarpEnable => "Enable or disable lens dewarping.
",
            ControlId::LensShadingCorrectionEnable => {
                "Enable or disable the lens shading correction.
"
            }
            ControlId::Hue => {
...
/// Enable or disable the lens shading correction.
#[derive(Debug, Clone)]
pub struct LensShadingCorrectionEnable(pub bool);
impl Deref for LensShadingCorrectionEnable {
    type Target = bool;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl DerefMut for LensShadingCorrectionEnable {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
impl TryFrom<ControlValue> for LensShadingCorrectionEnable {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<bool>::try_from(value)?))
    }
}
impl From<LensShadingCorrectionEnable> for ControlValue {
    fn from(val: LensShadingCorrectionEnable) -> Self {
        ControlValue::from(val.0)
    }
}
impl ControlEntry for LensShadingCorrectionEnable {
    const ID: u32 = ControlId::LensShadingCorrectionEnable as _;
}
impl Control for LensShadingCorrectionEnable {}
/// Adjusts the image hue (colour rotation) in degrees, as defined in
/// the HSL/HSV colour model.
///
/// The value represents a rotation around the hue circle in HSL/HSV space:
...
impl DerefMut for Hue {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
impl TryFrom<ControlValue> for Hue {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<f32>::try_from(value)?))
    }
}
impl From<Hue> for ControlValue {
    fn from(val: Hue) -> Self {
        ControlValue::from(val.0)
    }
}
impl ControlEntry for Hue {
    const ID: u32 = ControlId::Hue as _;
}
impl Control for Hue {}
/// Control for AE metering trigger. Currently identical to
/// ANDROID_CONTROL_AE_PRECAPTURE_TRIGGER.
///
/// Whether the camera device will trigger a precapture metering sequence
...
#[cfg(feature = "vendor_rpi")]
#[derive(Debug, Clone)]
pub struct ControlListSequence(pub i64);
#[cfg(feature = "vendor_rpi")]
impl Deref for ControlListSequence {
    type Target = i64;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[cfg(feature = "vendor_rpi")]
impl DerefMut for ControlListSequence {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
#[cfg(feature = "vendor_rpi")]
impl TryFrom<ControlValue> for ControlListSequence {
    type Error = ControlValueError;
    fn try_from(value: ControlValue) -> Result<Self, Self::Error> {
        Ok(Self(<i64>::try_from(value)?))
    }
...
#[cfg(feature = "vendor_rpi")]
impl From<ControlListSequence> for ControlValue {
    fn from(val: ControlListSequence) -> Self {
        ControlValue::from(val.0)
    }
}
#[cfg(feature = "vendor_rpi")]
impl ControlEntry for ControlListSequence {
    const ID: u32 = ControlId::ControlListSequence as _;
}
#[cfg(feature = "vendor_rpi")]
impl Control for ControlListSequence {}
pub fn make_dyn(
    id: ControlId,
    val: ControlValue,
    ...
    match id {
        ...
        ControlId::LensShadingCorrectionEnable => {
            Ok(Box::new(LensShadingCorrectionEnable::try_from(val)?))
        }
        ControlId::Hue => Ok(Box::new(Hue::try_from(val)?)),
        #[cfg(feature = "vendor_draft")]
        ControlId::AePrecaptureTrigger => {
        ...
        #[cfg(feature = "vendor_rpi")]
        ControlId::ControlListSequence => {
            Ok(Box::new(ControlListSequence::try_from(val)?))
        }
    }
}

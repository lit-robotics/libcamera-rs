...
use crate::control_value::{ControlValueError, Rectangle, Size};
...
impl Into<Size> for UnitCellSize {
    fn into(self) -> Size {
        self.0
    }
}
...
impl Into<Size> for PixelArraySize {
    fn into(self) -> Size {
        self.0
    }
}
...
impl TryFrom<Rectangle> for PixelArrayOpticalBlackRectangles {
    ...
    fn try_from(value: Rectangle) -> Result<Self, Self::Error> {
        Ok(Self(value))
    }
}

impl Into<Rectangle> for PixelArrayOpticalBlackRectangles {
...
impl Into<Rectangle> for PixelArrayActiveAreas {
    fn into(self) -> Rectangle {
        self.0
    }
}
...
impl Into<Rectangle> for ScalerCropMaximum {
    fn into(self) -> Rectangle {
        self.0
    }
}
